...
const Page = async ({ params }: { params: Promise<{ id: string }> }) => {
  ...
  //Parallel fetching of startup by id and editor picks
  //This is a good example of how to fetch multiple queries in parallel
  ...
  return (
    <>
      <section className="pink_container !min-h-[230px]">
        <p className="tag">{formatDateTime(post._createdAt)}</p>
